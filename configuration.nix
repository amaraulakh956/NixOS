...
sharedModules = [
  ...
  boot.initrd.luks.devices."luks-204d2b50-d6bb-4d7b-b1f8-c16972d2e759".device = "/dev/disk/by-uuid/204d2b50-d6bb-4d7b-b1f8-c16972d2e759";
...
# Also optimize the store (deduplicates files)
